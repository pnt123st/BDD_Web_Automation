...
public class WebAPI {
    ...
    public String browserstack_username= "mohammedihmannan1";
    public String browserstack_accesskey = "yXfXzBwNv3qz32gBfExw";
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.gecko.driver", "..//Users/mohammedmannan/IdeaProjects/New_Sele_FrameWork/Generic/Browser_Driver/Mac/geckodriver");
            }else if(OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.gecko.driver", "../Generic/Browser_Driver/Window/geckodriver.exe");
            }
